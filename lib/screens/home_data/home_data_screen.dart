  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      HomeCubit()
        ..getCat(widget.lang)
        ..
        getProduct(widget.lang)
        ..getSettings(widget.lang)
        ..getProOffer(widget.lang),
      child: BlocConsumer<HomeCubit, HomeState>(
        listener: (context, state) {},
        builder: (context, state) {
          var categoryList = HomeCubit
              .get(context)
              .categoryList;
          var productList = HomeCubit
              .get(context)
              .ProductList;
          var settingsModel = HomeCubit
              .get(context)
              .settingsModel;
          return Scaffold(
            body: Padding(
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    Container(
                        decoration: settingsModel.data!.homeBg == "" ?
            ...
            bottomNavigationBar: settingsModel == null ?
            const Center(
                child: SpinKitChasingDots(
                  color: customColor,
                  size: 40,
                )) :
            connectWithUsWhatsApp(context, widget.phone),
          );
        },
      ),
    );

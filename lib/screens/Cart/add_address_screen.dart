...
class _AddAddressScreenState extends State<AddAddressScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
      AddressCubit()
        ..getAddressData(widget.lang),
      child: BlocConsumer<AddressCubit, AddressState>(
        listener: (context, state) {
          // TODO: implement listener
        },
        builder: (context, state) {
          var countriesModel = AddressCubit
              .get(context)
              .countriesModel;
          var governoratesModel = AddressCubit
              .get(context)
              .governoratesModel;
          var cityModel = AddressCubit
              .get(context)
              .cityModel;
          return Scaffold(
            appBar: AppBar(
                  ...
                  validator: (value) {
                    ...
                    return null;
                      ...
                      DropdownButtonFormField2(
                        ...
                        isExpanded: true,
                        hint:  Text(
                          getTranslated(context, "Please select",)!,
                      ...
                      TextFormField(
                        ...
                        validator: (value) {
                          if (value!.isEmpty) {
                            return getTranslated(
                              context, "Please Enter Street Address.",)!
                            ;
                          }
                          return null;
                        },
                     ...
                     /* const SizedBox(height: 15),
                      ...
                      TextFormField(
                        ...
                        validator: (value) {
                          if (value!.isEmpty) {
                            return getTranslated(
                              context, "Please Enter Street Address2.",)!
                            ;
                          }
                          return null;
                        },
